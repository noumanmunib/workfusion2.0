    ...
    <div class="slide slide-1__background">
      ...
      <div class="slide-1__container">
        ...
        <div class="slide-1__image-container moveInTop duration--2">
          <img class="slide-1__dot-1" src="https://i.ibb.co/5ngvTZq/Screenshot-2024-06-10-at-16-52-28.png" alt="">
          <img v-if="!$matchMedia.xl" class="slide-1__dot-2" src="https://i.ibb.co/5ngvTZq/Screenshot-2024-06-10-at-16-52-28.png" alt="">
