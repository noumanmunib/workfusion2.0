<template>
  <div class="forgot-password__container">
    ...
    <p class="forgot-password__p">
      Don’t worry! Resetting your password is easy. Just type in this email field below that you registered on workfusion.
    </p>
    ...
    <form class="forgot-password__form--container" @submit.prevent="send" @keydown="form.onKeydown($event)">
      ...
      <div>
        ...
        <p class="forgot-password__further-information">
          For further information. Please kindly reach out to <a href="mailto:workfusionapp@gmail.com">workfusion@gmail.com</a>
        </p>
      </div>
